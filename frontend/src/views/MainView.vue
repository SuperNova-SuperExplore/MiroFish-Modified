...
// Step State
const currentStep = ref(1) // 1: Bangun graf, 2: Rancang simulasi, 3: Mulai simulasi, 4: Buat laporan, 5: Interaksi lanjut
const stepNames = ['Bangun graf', 'Rancang simulasi', 'Mulai simulasi', 'Buat laporan', 'Interaksi lanjut']
...
const handleNextStep = (params = {}) => {
  if (currentStep.value < 5) {
    currentStep.value++
    addLog(`Masuk Step ${currentStep.value}: ${stepNames[currentStep.value - 1]}`)
...
const handleGoBack = () => {
  if (currentStep.value > 1) {
    currentStep.value--
    addLog(`Kembali Step ${currentStep.value}: ${stepNames[currentStep.value - 1]}`)
  }
}
