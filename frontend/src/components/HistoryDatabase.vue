<template>
  ...
  >
    ...
    <div class="section-header">
      ...
      <span class="section-title">Riwayat simulasi</span>
      <div class="section-line"></div>
    </div>
      ...
      >
        ...
        <div class="card-files-wrapper">
          ...
          <div class="files-empty" v-else>
            ...
            <span class="empty-file-text">Belum ada file</span>
          </div>
        </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="modal-section">
                <div class="modal-label">Kebutuhan simulasi</div>
                <div class="modal-requirement">{{ selectedProject.simulation_requirement || 'Tidak ada' }}</div>
              </div>

              <!-- Catatan UI -->
              <div class="modal-section">
                <div class="modal-label">File terkait</div>
                ...
                <div class="modal-empty" v-else>Belum ada file terkait</div>
              </div>
            </div>
            ...
            <div class="modal-divider">
              ...
              <span class="divider-text">Replay simulasi</span>
              <span class="divider-line"></span>
            </div>
            ...
            <div class="modal-actions">
              ...
              >
                ...
                <span class="btn-text">Bangun graf</span>
              </button>
              <button
              ...
              >
                ...
                <span class="btn-icon">◈</span>
                <span class="btn-text">Rancang simulasi</span>
              </button>
              <button
              ...
              >
                ...
                <span class="btn-icon">◆</span>
                <span class="btn-text">Laporan analisis</span>
              </button>
            </div>
            <!-- Catatan replay -->
            <div class="modal-playback-hint">
              <span class="hint-text">Step 3 dan Step 5 harus dijalankan live, tidak tersedia sebagai replay</span>
            </div>
          </div>
        </div>
      </Transition>
...
const selectedProject = ref(null)  // Catatan internal
let observer = null
let isAnimating = false  // Catatan internal
let expandDebounceTimer = null  // Catatan internal
let pendingState = null  // Catatan internal
...
const getSimulationTitle = (requirement) => {
  if (!requirement) return 'Simulasi tanpa nama'
...
const truncateFilename = (filename, maxLength) => {
  if (!filename) return 'File tidak dikenal'
...
const loadHistory = async () => {
  try {
    ...
    console.error('Gagal memuat riwayat proyek:', error)
    projects.value = []
  } finally {
    loading.value = false
  }
...
/* Catatan styling */
.status-icon:nth-child(1).available { color: #3B82F6; } /* Catatan styling */
.status-icon:nth-child(2).available { color: #F59E0B; } /* Catatan styling */
.status-icon:nth-child(3).available { color: #10B981; } /* Catatan styling */
...
/* Catatan styling */
.card-progress.completed { color: #10B981; }    /* Catatan styling */
.card-progress.in-progress { color: #F59E0B; }  /* Catatan styling */
.card-progress.not-started { color: #9CA3AF; }  /* Catatan styling */
