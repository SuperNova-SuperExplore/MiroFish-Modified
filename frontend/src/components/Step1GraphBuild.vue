      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          ...
          <div class="step-status">
            ...
            <span v-else-if="currentPhase === 0" class="badge processing">Memproses</span>
        ...
        <div class="card-content">
          ...
          <div v-if="currentPhase === 0 && ontologyProgress" class="progress-section">
            ...
            <span>{{ ontologyProgress.message || 'Menganalisis dokumen...' }}</span>
          </div>
        ...
        <div class="card-content">
          ...
          <div class="stats-grid">
            <div class="stat-card">
              ...
              <span class="stat-label">Node entitas</span>
            </div>
            <div class="stat-card">
              <span class="stat-value">{{ graphStats.edges }}</span>
              <span class="stat-label">Edge relasi</span>
            </div>
            <div class="stat-card">
              <span class="stat-value">{{ graphStats.types }}</span>
              <span class="stat-label">Tipe schema</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Selesai dibangun</span>
          </div>
          <div class="step-status">
            <span v-if="currentPhase >= 2" class="badge accent">Berjalan</span>
          </div>
        </div>
...
const handleEnterEnvSetup = async () => {
  if (!props.projectData?.project_id || !props.projectData?.graph_id) {
    console.error('Data proyek atau graf belum lengkap')
    return
  }
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      ...
      console.error('Gagal membuat simulasi:', res.error)
      alert('Gagal membuat simulasi: ' + (res.error || 'Error tidak diketahui'))
    }
  } catch (err) {
    console.error('Terjadi error saat membuat simulasi:', err)
    alert('Terjadi error saat membuat simulasi: ' + err.message)
  } finally {
